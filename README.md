![](https://img.shields.io/badge/master分支-green.svg?logo=appveyor&style=for-the-badge)  ![](https://img.shields.io/badge/quartz实现定制化定时任务-green.svg?logo=appveyor&style=for-the-badge) 
> ##  主要内容
> *   系统启动初始化加载已有的定时任务
> *   启动or暂停定时任务
> *   立即运行定时任务
